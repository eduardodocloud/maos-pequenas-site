/* =====================================================
   ...
   Funciona em qualquer browser, sem cadastro em serviço externo.
   ===================================================== */
(function () {
  ...
  function serializeForm(form) {
    ...
    for (const [key, value] of fd.entries()) {
      ...
      // Múltiplos checkboxes com mesmo name viram lista
  ...
  function handleForm(formId, subject) {
    ...
    // Remove handlers AJAX antigos clonando o form
